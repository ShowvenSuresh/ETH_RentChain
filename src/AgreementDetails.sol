...
contract AgreementContract {
    ...
    function createAgreement(address payable _tenant, address payable _landord, uint256 _rentAmount, uint256 _durationInMonths, string memory _status) public {
        Agreement memory a ;
        a.tenant= _tenant;
        a.landlord = _landord;
    ...
    function terminateAgreement(uint _agrmtId) public {
